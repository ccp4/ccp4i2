...
from ccp4i2.pipelines.import_merged.script.dybuttons import ChoiceButtons
import os
import shutil
import gemmi
...
class Cservalcat_pipe(CCP4TaskWidget.CTaskWidget):
  ...
  DESCRIPTION='Refinement against diffraction data with optional restraints (ProSMART, MetalCoord)'
