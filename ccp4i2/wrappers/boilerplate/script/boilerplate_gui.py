"""
    ZZPluginNameZZ_gui.py: CCP4 GUI Project
...
#-------------------------------------------------------------------
class ZZPluginNameZZ_gui(CTaskWidget):
    #-------------------------------------------------------------------

    # Subclass CTaskWidget to give specific task window
    TASKNAME = 'ZZPluginNameZZ' # this has to match the pluginName given in the corresponding .def.xml
    TASKVERSION = 0.1
