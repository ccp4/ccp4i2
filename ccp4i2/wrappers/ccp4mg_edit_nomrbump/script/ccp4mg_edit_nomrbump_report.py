...
class ccp4mg_edit_no_mrbump_report(Report):
    ...
    def __init__(self,xmlnode=None,jobInfo={},jobStatus=None,**kw):
        ...
        pdbsWrittenPath = './/ccp4mg_edit_nomrbump/number_output_files'
    ...
    def drawWarnings(self, parent=None):
        ...
        if len(warnings)>0:
            ...
            warningsFolder.addText(text='No warnings from ccp4mg_edit_nomrbump')
        return
    ...
    def drawPictures(self, xmlnode=None, jobInfo=None, parent=None, objectNameMap={}, initiallyOpen=True):
        ...
        baseScenePath = os.path.join(ccp4i2_root,'wrappers','ccp4mg_edit_nomrbump','script','ccp4mg_edit_nomrbump.scene.xml')
