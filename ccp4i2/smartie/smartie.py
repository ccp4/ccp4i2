...
class buffer:
    ...
    def tail(self,n=10):
        ...
        # optimization: don't use contents(), len() and all these "helpers"
        return "\n".join(self.__contents[-n:])
...
class program(fragment):
    ...
    def logicalnames(self):
        ...
        return list(self.__logicalnames.keys())
...
class table:
    ...
    def add_data(self,rowdata):
        ...
        """
        if len(list(rowdata.keys())) == 0:
            # No columns were specified
            return
        for colnam in list(rowdata.keys()):
