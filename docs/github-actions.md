...
What is deliberately *not* in it: `tests/db/` does not collect without the
`[science]` extra (`ccp4i2/lib/utils/formats/mtz.py` imports pandas at module
scope), and `tests/i2run/` and `tests/api/e2e/` run real
