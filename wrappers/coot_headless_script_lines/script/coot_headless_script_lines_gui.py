"""
tasks/coot_headless_script_lines
"""
...
#-------------------------------------------------------------------
class Ccoot_headless_script_lines(CTaskWidget):
    #-------------------------------------------------------------------
    
    # Subclass CTaskWidget to give specific task window
    TASKNAME = 'coot_headless_script_lines'
    TASKVERSION = 0.1
    TASKMODULE='model_building'
    TASKTITLE  = 'Scripted model building - Coot Headless'
    SHORTTASKTITLE  = 'Scripted COOT Headless'
    DESCRIPTION='''Use scripts to fit sidechains, perform stepped refinement, fill and fit... (non-interactive Coot)'''
    
    def drawContents(self):
        
        
        self.setProgramHelpFile('coot_headless_script_lines')
        
        self.openFolder(folderFunction='inputData')
        
        self.createLine( [ 'subtitle', 'Modelss:' ] )
