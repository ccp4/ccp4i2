...
#-------------------------------------------------------------------
class Ccoot4pe_rebuild(CTaskWidget):
#-------------------------------------------------------------------

# Subclass CTaskWidget to give specific task window
  TASKNAME = 'coot4pe_rebuild'
  TASKVERSION = 0.1
  TASKMODULE='model_building'
  TASKTITLE='Model building - COOT'
  SHORTTASKTITLE='COOT1'
  DESCRIPTION='Interactive building (Coot 1)'

  WHATNEXT = ['prosmart_refmac','coot_rebuild', 'buccaneer_build_refine_mr','coot4pe_rebuild' ]
