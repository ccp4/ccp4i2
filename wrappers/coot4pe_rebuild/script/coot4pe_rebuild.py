...
class coot4pe_rebuild(CPluginScript):
            ...
            try:
                ...
                for XYZIN in self.container.inputData.XYZIN_LIST:
                    if os.path.isfile(XYZIN.__str__()):
                        ...
                        print('coot4pe_rebuild.makeCommandAndScript XYZIN does not exist:',XYZIN.__str__())
                    iFile += 1
            except:
            ...
            try:
                ...
                for FPHIIN in self.container.inputData.FPHIIN_LIST:
                    ...
                    if os.path.isfile(FPHIIN.__str__()):
                        ...
                        print('coot4pe_rebuild.makeCommandAndScript FPHIIN does not exist:',FPHIIN.__str__())
                    iFile += 1
                    iMapNo += 1
            except:
                print(' Exception ')
...
#Make anomolous difference maps white.
                        ...
                        print('coot4pe_rebuild.makeCommandAndScript FPHIIN does not exist:',DELFPHIIN.__str__())
                    iFile += 1
                    iMapNo += 1
            except:
                print(' Exception ')
...
#Make anomolous difference maps white.
    ...
    def handleFileDrop(self,directory):
        import time,glob
        print('coot4pe_rebuild',time.time())
        print('coot4pe_rebuild',glob.glob(os.path.join(self.workDirectory,'*.*')))
