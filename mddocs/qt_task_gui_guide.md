...
## 20. Source Files to Read from the Main Branch

The following Python files each contain a class derived from `CTaskWidget` and represent the
complete set of Qt task GUIs that need React equivalents. This list was generated by searching
for class definitions inheriting from `CTaskWidget` (directly or indirectly).

Each task GUI file should be read alongside its corresponding `def.xml` file (same directory,
replacing `_gui.py` or the class file name with `.def.xml`).

### Direct CTaskWidget Subclasses

#### Wrappers

| File | Class |
|------|-------|
| `wrappers/AMPLE/script/AMPLE_gui.py` | `AMPLE_gui` |
| `wrappers/AcedrgLink/script/AcedrgLink_gui.py` | `AcedrgLink_gui` |
| `wrappers/AlternativeImportXIA2/script/AlternativeImportXIA2_gui.py` | `CTaskAlternativeImportXIA2` |
| `wrappers/AUSPEX/script/CTaskAUSPEX.py` | `CTaskAUSPEX` |
| `wrappers/MakeMonster/script/MakeMonster_gui.py` | `MakeMonster_gui` |
| `wrappers/ProvideTLS/script/ProvideTLS_GUI.py` | `CProveideTLS` |
| `wrappers/ProvideAlignment/script/ProvideAlignment_gui.py` | `CTaskProvideAlignment` |
| `wrappers/ProvideAsuContents/script/ProvideAsuContents_gui.py` | `CTaskProvideAsuContents` |
| `wrappers/ProvideSequence/script/ProvideSequence_gui.py` | `CTaskProvideSequence` |
| `wrappers/SIMBAD/script/SIMBAD_gui.py` | `SIMBAD_gui` |
| `wrappers/ShelxCDE/script/ShelxCD_gui.py` | `ShelxCD_gui` |
| `wrappers/ShelxCDE/script/ShelxCE_gui.py` | `ShelxCE_gui` |
| `wrappers/SubtractNative/script/SubtractNative_gui.py` | `SubtractNative_gui` |
| `wrappers/SyncToDjango/script/SyncToDjango.py` | `SyncToDjango` |
| `wrappers/TestObsConversions/script/TestObsConversions_gui.py` | `TestObsConversions_gui` |
| `wrappers/acorn/script/CTaskAcorn.py` | `CTaskAcorn` |
| `wrappers/add_fractional_coords/script/add_fractional_coords_gui.py` | `add_fractional_coords_gui` |
| `wrappers/adding_stats_to_mmcif_i2/script/adding_stats_to_mmcif_i2_gui.py` | `adding_stats_to_mmcif_i2_gui` |
| `wrappers/arcimboldo/script/arcimboldo_gui.py` | `arcimboldo_gui` |
| `wrappers/areaimol/script/CTaskareaimol.py` | `CTaskAreaimolUI` |
| `wrappers/arp_warp_classic/script/CArpWarpClassic.py` | `CTaskArpWarpClassic` |
| `wrappers/boilerplate/script/boilerplate_gui.py` | `ZZPluginNameZZ_gui` |
| `wrappers/buster/script/CTaskbuster.py` | `CTaskbuster` |
| `wrappers/ccp4mg_edit_model/script/ccp4mg_edit_model_gui.py` | `Cccp4mg_edit_model` |
| `wrappers/ccp4mg_edit_nomrbump/script/ccp4mg_edit_nomrbump_gui.py` | `Cccp4mg_edit_nomrbump` |
| `wrappers/ccp4mg_general/script/ccp4mg_general_gui.py` | `Cccp4mg_general` |
| `wrappers/chainsaw/script/CTaskChainsaw.py` | `CTaskChainsaw` |
| `wrappers/chltofom/script/chltofom_gui.py` | `CTaskchltofom` |
| `wrappers/cif2mtz/script/CTaskCif2mtz.py` | `CTaskCif2mtz` |
| `wrappers/clustalw/script/clustalw_gui.py` | `clustalw_gui` |
| `wrappers/cmapcoeff/script/cmapcoeff_gui.py` | `cmapcoeff_gui` |
| `wrappers/comit/script/comit_gui.py` | `comit_gui` |
| `wrappers/coordinate_selector/script/coordinate_selector_gui.py` | `coordinate_selector_gui` |
| `wrappers/coot1/script/coot1_gui.py` | `Ccoot1` |
| `wrappers/coot_find_waters/script/coot_find_waters_gui.py` | `Ccoot_find_waters` |
| `wrappers/coot_rebuild/script/coot_rebuild_gui.py` | `Ccoot_rebuild` |
| `wrappers/coot_rsr_morph/script/coot_rsr_morph_gui.py` | `Ccoot_rsr_morph` |
| `wrappers/coot_script_lines/script/coot_script_lines_gui.py` | `Ccoot_script_lines` |
| `wrappers/cpatterson/script/cpatterson_gui.py` | `cpatterson_gui` |
| `wrappers/csymmatch/script/csymmatch_gui.py` | `csymmatch_gui` |
| `wrappers/ctruncate/script/ctruncate_gui.py` | `ctruncate_gui` |
| `wrappers/density_calculator/script/density_calculator_gui.py` | `density_calculator_gui` |
| `wrappers/dials_image/script/CTaskDials_image.py` | `CTaskDials_image` |
| `wrappers/dials_rlattice/script/CTaskDials_rlattice.py` | `CTaskDials_rlattice` |
| `wrappers/dui/script/CTaskdui.py` | `CTaskdui` |
| `wrappers/editbfac/script/editbfac_gui.py` | `editbfac_gui` |
| `wrappers/edstats/script/CTaskEdstats.py` | `CTaskEdstats` |
| `wrappers/findmyseq/script/CTaskfindmyseq.py` | `CTaskfindmyseq` |
| `wrappers/freerflag/script/CTaskFreerflag.py` | `CTaskFreerflag` |
| `wrappers/gesamt/script/CTaskgesamt.py` | `CTaskGesamt` |
| `wrappers/i2Dimple/script/i2Dimple_gui.py` | `i2Dimple_gui` |
| `wrappers/import_mosflm/script/import_mosflm_gui.py` | `CTaskImportMosflm` |
| `wrappers/import_serial/script/CTaskimport_serial.py` | `CTaskimport_serial` |
| `wrappers/lorestr_i2/script/lorestr_i2_gui.py` | `lorestr_i2_gui` |
| `wrappers/matthews/script/matthews.py` | `matthews_gui` |
| `wrappers/mergeMtz/script/mergeMtz_gui.py` | `mergeMtz_gui` |
| `wrappers/metalCoord/script/metalCoord_gui.py` | `CmetalCoord_gui` |
| `wrappers/modelASUCheck/script/modelASUCheck_gui.py` | `modelASUCheck_gui` |
| `wrappers/modelcraft/script/modelcraft_gui.py` | `modelcraft_gui` |
| `wrappers/molrep_den/script/Cmolrep_den.py` | `Cmolrep_den` |
| `wrappers/molrep_mr/script/Cmolrep_mr.py` | `Cmolrep_mr` |
| `wrappers/molrep_selfrot/script/Cmolrep_selfrot.py` | `Cmolrep_selfrot` |
| `wrappers/morda_i2/script/morda_i2_gui.py` | `morda_i2_gui` |
| `wrappers/mosflm/script/mosflm_gui.py` | `CTaskpointless` |
| `wrappers/mrparse/script/CTaskmrparse.py` | `CTaskmrparse` |
| `wrappers/mrbump_basic/script/Cmrbump_basic.py` | `Cmrbump_basic` |
| `wrappers/mtzutils/script/CTaskMtzutils.py` | `CTaskMtzutils` |
| `wrappers/pairef/script/CTaskpairef.py` | `CTaskpairef` |
| `wrappers/parrot/script/CTaskParrot.py` | `CTaskParrot` |
| `wrappers/pdb_redo_api/script/pdb_redo_api_gui.py` | `CTaskPDB_REDO` |
| `wrappers/pdbset_ui/script/CTaskpdbset_ui.py` | `CTaskPDBSetUI` |
| `wrappers/pdbview_edit/script/pdbview_edit_gui.py` | `Cpdbview_edit` |
| `wrappers/phaser_ensembler/script/phaser_ensembler_gui.py` | `phaser_ensembler_gui` |
| `wrappers/phaser_phil/script/phaser_phil_gui.py` | `phaser_phil_gui` |
| `wrappers/phaser_singleMR/script/CTaskPhaserSingleMR.py` | `CTaskPhaserSingleMR` |
| `wrappers/pointless_reindexToMatch/script/pointless_reindexToMatch_gui.py` | `pointless_reindexToMatch_gui` |
| `wrappers/privateer/script/privateer_gui.py` | `privateer_gui` |
| `wrappers/prosmart/script/CTaskProsmart.py` | `CTaskProsmart` |
| `wrappers/pyphaser_mr/script/CTaskPyphaser_mr.py` | `CTaskPyphaser_mr` |
| `wrappers/qtpisa/script/qtpisa_gui.py` | `Cqtpisa` |
| `wrappers/scaleit/script/CTaskscaleit.py` | `CTaskscaleit` |
| `wrappers/sculptor/script/CTaskSculptor.py` | `CTaskSculptor` |
| `wrappers/sheetbend/script/sheetbend_gui.py` | `sheetbend_gui` |
| `wrappers/shelxeMR/script/CTaskShelxeMR.py` | `CTaskShelxeMR` |
| `wrappers/slicendice/script/Cslicendice.py` | `Cslicendice` |
| `wrappers/splitMtz/script/CTaskSplitMtz.py` | `CTaskSplitMtz` |
| `wrappers/validate_protein/script/validate_protein_gui.py` | `validate_protein_gui` |
| `wrappers/xia2_dials/script/xia2_dials_gui.py` | `xia2_dials_gui` |
| `wrappers/xia2_multiplex/script/xia2_multiplex_gui.py` | `xia2_multiplex_gui` |
| `wrappers/xia2_ssx_reduce/script/xia2_ssx_reduce_gui.py` | `xia2_ssx_reduce_gui` |
| `wrappers/zanuda/script/zanuda_gui.py` | `zanuda_gui` |

#### Pipelines

| File | Class |
|------|-------|
| `pipelines/LidiaAcedrg/script/lidiaAcedrg_gui.py` | `lidiaAcedrg_gui` |
| `pipelines/LidiaAcedrgNew/script/lidiaAcedrgNew_gui.py` | `lidiaAcedrgNew_gui` |
| `pipelines/MakeLink/script/MakeLink_gui.py` | `MakeLink_gui` |
| `pipelines/MakeProjectsAndDoLigandPipeline/script/MakeProjectsAndDoLigandPipeline_gui.py` | `MakeProjectsAndDoLigandPipeline_gui` |
| `pipelines/PrepareDeposit/script/PrepareDeposit_gui.py` | `PrepareDeposit_gui` |
| `pipelines/SubstituteLigand/script/SubstituteLigand_gui.py` | `SubstituteLigand_gui` |
| `pipelines/aimless_pipe/script/CTaskaimless_pipe.py` | `CTaskaimless_pipe` |
| `pipelines/boilerplate/script/boilerplate_gui.py` | `ZZPipelineNameZZ_gui` |
| `pipelines/buccaneer_build_refine_mr/script/CTaskbuccaneer_build_refine_mr.py` | `CTaskbuccaneer_build_refine_mr` |
| `pipelines/crank2/script/CTaskCrank2.py` | `CTaskCrank2` |
| `pipelines/dr_mr_modelbuild_pipeline/script/dr_mr_modelbuild_pipeline_gui.py` | `Cdr_mr_modelbuild_pipeline` |
| `pipelines/dr_mr_modelbuild_pipeline/wrappers/mrbump_model_prep/script/mrbump_model_prep_gui.py` | `Cmrbump_model_prep` |
| `pipelines/import_merged/script/Ctaskimport_merged.py` | `CTaskimport_merged` |
| `pipelines/import_serial_pipe/script/CTaskimport_serial_pipe.py` | `CTaskimport_serial_pipe` |
| `pipelines/molrep_pipe/script/molrep_gui.py` | `Cmolrep_pipe` |
| `pipelines/nautilus_build_refine/script/nautilus_build_refine_gui.py` | `nautilus_build_refine_gui` |
| `pipelines/phaser_pipeline/wrappers/phaser_EP_AUTO/script/phaser_EP_AUTO_gui.py` | `phaser_EP_AUTO_gui` |
| `pipelines/phaser_pipeline/wrappers/phaser_EP_LLG/script/phaser_EP_LLG_gui.py` | `phaser_EP_LLG_gui` |
| `pipelines/phaser_pipeline/wrappers/phaser_MR_AUTO/script/phaser_MR_AUTO_gui.py` | `phaser_MR_AUTO_gui` |
| `pipelines/phaser_pipeline/wrappers/phaser_MR_RNP/script/phaser_MR_RNP_gui.py` | `phaser_MR_RNP_gui` |
| `pipelines/pisapipe/script/pisapipe_gui.py` | `CTaskPisapipe` |
| `pipelines/prosmart_refmac/script/prosmart_refmac_gui.py` | `Cprosmart_refmac` |
| `pipelines/servalcat_pipe/script/servalcat_pipe_gui.py` | `Cservalcat_pipe` |
| `pipelines/tableone/script/CTasktableone.py` | `CTasktableone` |

#### Tasks and Other Locations

| File | Class |
|------|-------|
| `tasks/import_xia2/CTaskimport_xia2.py` | `CTaskimport_xia2` |
| `tasks/newProject_fromMerged/CTaskNewProject_fromMerged.py` | `CTaskNewProject_fromMerged` |
| `tasks/phaser_mr/CTaskPhaser_mr.py` | `CTaskPhaser_mr` |
| `tasks/unique/CTaskUnique.py` | `CTaskUnique` |
| `wrappers2/CTaskWorkflow.py` | `CTaskWorkflow` |
| `wrappers2/dummy/script/CTaskDummy.py` | `CTaskDummy` |
| `wrappers2/guipreferences/script/CGuiPreferences.py` | `CGuiPreferences` |

### Indirect Subclasses (Inherit from Another GUI Class)

These inherit from a task GUI class listed above rather than directly from `CTaskWidget`.
When translating these, their parent GUI class should be translated first.

| File | Class | Inherits From |
|------|-------|---------------|
| `pipelines/phaser_pipeline/script/phaser_pipeline_gui.py` | `phaser_pipeline_gui` | `phaser_MR_AUTO_gui` |
| `pipelines/phaser_simple/script/phaser_simple_gui.py` | `phaser_simple_gui` | `phaser_pipeline_gui` |
| `pipelines/phaser_ep/script/phaser_EP_gui.py` | `phaser_EP_gui` | `phaser_EP_AUTO_gui` |
| `pipelines/phaser_rnp_pipeline/script/phaser_rnp_pipeline_gui.py` | `phaser_rnp_pipeline_gui` | `phaser_MR_RNP_gui` |
| `wrappers/xia2_xds/script/xia2_xds_gui.py` | `xia2_xds_gui` | `xia2_dials_gui` |
| `wrappers/ShelxCDE/script/ShelxCECompareHands_gui.py` | `ShelxCECompareHands_gui` | `ShelxCE_gui` |
| `pipelines/crank2/wrappers/crank2_substrdet/script/CTaskCrank2substrdet.py` | `CTaskCrank2substrdet` | `CTaskCrank2` |
| `pipelines/crank2/wrappers/crank2_faest/script/CTaskCrank2faest.py` | `CTaskCrank2faest` | `CTaskCrank2` |
| `pipelines/crank2/wrappers/crank2_phas/script/CTaskCrank2phas.py` | `CTaskCrank2phas` | `CTaskCrank2` |
| `pipelines/crank2/wrappers/crank2_ref/script/CTaskCrank2ref.py` | `CTaskCrank2ref` | `CTaskCrank2` |
| `pipelines/crank2/wrappers/crank2_comb_phdmmb/script/CTaskCrank2comb_phdmmb.py` | `CTaskCrank2comb_phdmmb` | `CTaskCrank2` |
| `pipelines/crank2/wrappers/crank2_dmfull/script/CTaskCrank2dmfull.py` | `CTaskCrank2dmfull` | `CTaskCrank2` |
| `pipelines/crank2/wrappers/crank2_phdmmb/script/CTaskCrank2phdmmb.py` | `CTaskCrank2phdmmb` | `CTaskCrank2` |
| `pipelines/crank2/wrappers/crank2_mbref/script/CTaskCrank2mbref.py` | `CTaskCrank2mbref` | `CTaskCrank2` |
| `pipelines/crank2/wrappers/crank2_handdet/script/CTaskCrank2handdet.py` | `CTaskCrank2handdet` | `CTaskCrank2` |
| `pipelines/crank2/wrappers/crank2_refatompick/script/CTaskCrank2refatompick.py` | `CTaskCrank2refatompick` | `CTaskCrank2` |
| `pipelines/shelx/script/CTaskShelx.py` | `CTaskShelx` | `CTaskCrank2` |

### Deprecated

| File | Class | Notes |
|------|-------|-------|
| `deprecated/tasks/refmac_wrk/CRefmacWrk.py` | `CRefmacWrk` | Deprecated — skip |

---

**Total: 120 direct subclasses + 17 indirect subclasses + 1 deprecated = 138 GUI source files.**

---

*This guide was generated from analysis of all task GUI files, the CTaskWidget base class
