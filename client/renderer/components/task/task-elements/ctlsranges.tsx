...
// ============================================================
// Shared utilities (same as coccupancygroups.tsx)
// ============================================================
...
// ============================================================
// InlineCell (same as coccupancygroups.tsx)
// ============================================================
...
// ============================================================
// InlineSelect for TLS selection field (ALL/BACKBONE)
// ============================================================
...
const InlineSelect: React.FC<InlineSelectProps> = ({
  ...
  const [localValue, setLocalValue] = useState(serverValue || "ALL");

  useEffect(() => {
    setLocalValue(serverValue || "ALL");
  }, [serverValue]);
  ...
  const handleChange = useCallback(
    async (e: any) => {
      ...
      if (newVal !== serverValue) {
        await setParameter({ object_path: objectPath, value: newVal });
      }
    },
    [objectPath, serverValue, setParameter]
  );
...
//
// Renders CTLSRangeList as a table:
// | Group ID | Chain | From | To | Selection | [delete] |
// ============================================================

export const CTLSRangeListElement: React.FC<CCP4i2TaskElementProps> = (
  props
) => {
  ...
  const handleAddRow = useCallback(async () => {
    ...
    try {
      ...
      console.error("Error adding TLS range row:", error);
    }
  ...
  const handleDeleteRow = useCallback(
    async (index: number) => {
      ...
      try {
        ...
        console.error("Error deleting TLS range row:", error);
      }
    },
        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell sx={{ fontWeight: "bold", width: "7rem" }}>
                Selection
              </TableCell>
            ...
            {rows.map((row: any, index: number) => {
              ...
              return (
                <TableRow key={row._objectPath || index}>
                  ...
                  <TableCell sx={{ py: 0.5 }}>
                    <InlineSelect
                      objectPath={v.selection?._objectPath}
                      serverValue={v.selection?._value}
                      disabled={!isEditable}
                      setParameter={setParameter}
                    />
                  </TableCell>
