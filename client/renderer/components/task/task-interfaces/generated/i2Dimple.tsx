      ...
      <CCP4i2Tabs>
        <CCP4i2Tab key="inputData" label="Input data">
          ...
          >
            ...
            <CCP4i2TaskElement itemName="FREERFLAG" {...props} qualifiers={{ toolTip: "Free R" }} />
          </CCP4i2ContainerElement>
          <Typography variant="subtitle1" sx={{ fontWeight: "bold", mt: 2, mb: 1 }}>
            Control parameters
          </Typography>
          <CCP4i2ContainerElement
            ...
            containerHint="BlockLevel"
          >
            <CCP4i2TaskElement itemName="MR_WHEN_R" {...props} qualifiers={{ guiLabel: "R-factor threshold to force MR" }} />
          </CCP4i2ContainerElement>
        </CCP4i2Tab>
      </CCP4i2Tabs>
    </Paper>
