...
OR specify where they are in the Preferences window - under Other Software." {...props} />
          <CCP4i2TaskElement itemName="MODE" {...props} qualifiers={{ guiLabel: "Experiment type", toolTip: "What sort of data are available" }} />
          ...
          >
            <CCP4i2TaskElement itemName="HAIN" {...props} />
          </CCP4i2ContainerElement>
          <CCP4i2ContainerElement
            {...props}
            itemName=""
