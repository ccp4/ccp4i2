  ...
  return (
    <Paper sx={{ display: "flex", flexDirection: "column", gap: 1, p: 1 }}>
      ...
      >
        ...
        <CCP4i2TaskElement itemName="SEARCHMODE" {...props} qualifiers={{ guiLabel: "Use the ensembles below as" }} />
        <CCP4i2TaskElement itemName="ENSEMBLES" {...props} qualifiers={{ guiLabel: "List of search model ensembles" }} />
      </CCP4i2ContainerElement>
