...
/**
 * Provider component that loads RDKit WASM module.
 *
 * This is the core ccp4i2 RDKit provider that works in both
 * Electron (desktop) and web (Docker) modes.
 *
 * The compounds app overlay may replace this with its own version
 * during Docker build, but both have compatible interfaces.
 */
