#!/bin/bash
# Wrapper script for campaign_uploader that sets up the environment automatically.
#
# Usage:
#   ./run_uploader.sh scan /path/to/data
#   ./run_uploader.sh plan scan.yaml
#   ./run_uploader.sh execute plan.yaml --campaign-id 61
#
