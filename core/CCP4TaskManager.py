...
MODULE_DEFAULTS = {'molecular_replacement' : ['mrbump_basic', 'phaser_simple', 'phaser_pipeline', 'molrep_pipe', 'molrep_den','csymmatch', 'parrot', 'phaser_rnp_pipeline' ],
                   ...
                   'model_building'        : ['buccaneer_build_refine_mr', 'coot_rebuild','coot_script_lines', 'coot_find_waters','modelcraft','arp_warp_classic','nautilus_build_refine','shelxeMR','dr_mr_modelbuild_pipeline'],
