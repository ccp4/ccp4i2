...
from ccp4i2.core.conversions.servalcat_converter import ServalcatConverter as ConverterImpl

# Option 2: Use ctruncate (legacy)
from ccp4i2.core.conversions.ctruncate_converter import CtruncateConverter as ConverterImpl
