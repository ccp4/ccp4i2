...
class CPhaserTngDagFileStub(CDataFile):
    """
    A PhaserTNG DAG file (directed acyclic graph of a picard MR pipeline)

    This is a pure data class stub. Extend it in core/CCP4XtalData.py
    to add methods and implementation-specific functionality.
    """
    ...
    def __init__(self, parent=None, name=None, **kwargs):
        """
        Initialize CPhaserTngDagFileStub.
