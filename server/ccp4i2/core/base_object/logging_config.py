...
Usage:
    from ccp4i2.core.base_object.logging_config import get_logger
...
def configure_quiet_mode():
    ...
    Example:
        from ccp4i2.core.base_object.logging_config import configure_quiet_mode
...
def configure_debug_mode():
    ...
    Example:
        from ccp4i2.core.base_object.logging_config import configure_debug_mode
