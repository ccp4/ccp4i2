...
TASKS = {
    ...
    "comit": Task(
        ...
        autogenerated=True,
        pluginPath="ccp4i2.wrappers.comit.script.comit:comit",
        defXmlPath="wrappers/comit/script/comit.def.xml",
        reportPath="ccp4i2.wrappers.comit.script.comit_report:comit_report",
    ),
    "convert2mtz": Task(
