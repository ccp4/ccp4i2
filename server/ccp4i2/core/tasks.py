...
TASKS = {
    ...
    "dnatco": Task(
        title="DNATCO - Restrain and validate nucleic acid structures",
        description="Assign dinucleotide conformers (NtC), validate bond geometry (NAVAL) and generate NtC restraints for one model",
        shortTitle="DNATCO",
        pluginPath="ccp4i2.wrappers.dnatco.script.dnatco:dnatco",
        defXmlPath="wrappers/dnatco/script/dnatco.def.xml",
        reportPath="ccp4i2.wrappers.dnatco.script.dnatco_report:dnatco_report",
        runningReport=True,
    ),
    "dnatco_pipe": Task(
        title="DNATCO - Restrain and validate nucleic acid structures",
        description="Validate one or two nucleic acid models with DNATCO (NtC conformer assignment, NAVAL bond geometry) and optionally generate NtC restraints for refinement",
        shortTitle="DNATCO",
        pluginPath="ccp4i2.pipelines.dnatco_pipe.script.dnatco_pipe:dnatco_pipe",
        defXmlPath="pipelines/dnatco_pipe/script/dnatco_pipe.def.xml",
        reportPath="ccp4i2.pipelines.dnatco_pipe.script.dnatco_pipe_report:dnatco_pipe_report",
        runningReport=True,
    ),
