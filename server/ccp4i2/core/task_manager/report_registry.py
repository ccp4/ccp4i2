...
_PATHS = {
    ...
    "acedrg": "ccp4i2.wrappers.acedrg.script.acedrg_report:acedrg_report",
    "acedrgNew": "ccp4i2.wrappers.acedrgNew.script.acedrgNew_report:acedrgNew_report",
    ...
    "aimless_pipe": "ccp4i2.pipelines.aimless_pipe.script.aimless_pipe_report:aimless_pipe_report",
    ...
    "tableone": "ccp4i2.pipelines.tableone.script.tableone_report:tableone_report",
