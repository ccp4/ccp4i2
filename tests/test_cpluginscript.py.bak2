...
def test_cpluginscript_instantiation():
    ...
    assert script.inputData is not None
    assert script.outputData is not None
    assert script.controlParameters is not None
    assert script.guiAdmin is not None
...
def test_cpluginscript_subcontainers():
    ...
    assert script.inputData.name == "inputData"
    assert script.outputData.name == "outputData"
    assert script.controlParameters.name == "controlParameters"
    assert script.guiAdmin.name == "guiAdmin"

    # Check that they are children of the main container
    assert script.inputData.parent == script.container
    assert script.outputData.parent == script.container
...
def test_cpluginscript_hierarchy():
    ...
    assert script.inputData.parent == script.container
    assert script.outputData.parent == script.container
    assert script.controlParameters.parent == script.container
    assert script.guiAdmin.parent == script.container
    ...
    assert script.inputData.object_path() == "test_script.container.inputData"
